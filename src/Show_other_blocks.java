...
public class Show_other_blocks extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Show_other_blocks(ArrayList<String> blok_bilg_0) {
		...
		textArea.setText(blok_bilg_0.get(5));
		...
		textmuh.setText(blok_bilg_0.get(6));
		...
		textArea1.setText(blok_bilg_0.get(10));
		...
		textField.setText(blok_bilg_0.get(0));
		...
		textField_1.setText(blok_bilg_0.get(1));
		...
		textArea_1.setText(blok_bilg_0.get(3));
		...
		textArea_2.setText(blok_bilg_0.get(4));
		...
		textField_2.setText(blok_bilg_0.get(2));
